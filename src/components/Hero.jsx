    ...
    <section className="relative overflow-hidden bg-bg text-foreground">
      ...
      <div className="max-w-6xl mx-auto px-4 py-24 md:py-32 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        >
          <motion.span
            variants={item}
            className="inline-flex items-center gap-2 text-xs tracking-[0.3em] uppercase text-primary"
          >
          ...
          <motion.p variants={item} className="text-muted text-lg max-w-xl">
          ...
          <motion.div
            variants={item}
            className="flex items-center gap-5 text-muted text-sm"
          >
          ...
          <motion.div variants={item} className="flex gap-6 text-sm text-muted">
            <a
        ...
        >
          <motion.div
            ...
            className="w-72 h-96 md:w-80 md:h-[26rem] rounded-3xl overflow-hidden border border-border/20 shadow-2xl bg-surface/70"
          >
            <img
              src="/profile.jpg"
